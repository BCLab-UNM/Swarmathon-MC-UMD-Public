...
enum Type{ SEARCH_BEHAVIOR_TYPE, AVOID_BEHAVIOR_TYPE, PICKUP_BEHAVIOR_TYPE,
           ...
           DRIVE_BEHAVIOR_TYPE, SEARCH_FOR_DROP_BEHAVIOR_TYPE, SEARCH_ALGORITHM_BEHAVIOR_TYPE, 
           AVOID_CENTER_BEHAVIOR_TYPE,
           SEARCH_ALGORITHM_RELATIVE_BEHAVIOR_TYPE, SEARCH_ALGORITHM_SIX_ROVERS_BEHAVIOR_TYPE};
